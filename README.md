...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/knair9/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/knair9/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/knair9/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/knair9/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/knair9/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/knair9/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |      17m19.790s                     |            1m40.992s               | 
| `pg_normalized_batch`  |      1m39.629s                     |         0m12.591s                  | 
| `pg_denormalized`      |       0m14.557s                    |         0m2.616s                  | 
